"""Shared user-facing formatting with legacy-compatible text."""
...
async def get_creator_info() -> str:
    """Provides information about Amin Foroutan, the creator of MCP-GSC."""
    creator_info = """
...
__all__ = ["get_creator_info", "site_not_found_error"]
