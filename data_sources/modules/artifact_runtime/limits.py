...
GOVERNANCE_JSON_MAX_BYTES = JSON_MAX_BYTES
HUMAN_OUTPUT_MAX_BYTES = MIB
MCP_TEXT_MAX_BYTES = MIB
GSC_PAGE_MAX_BYTES = 8 * MIB
GSC_WORKFLOW_MAX_BYTES = 32 * MIB
RETENTION_JOURNAL_MAX_BYTES = 32 * MIB
SUBPROCESS_SPOOL_THRESHOLD_BYTES = MIB
SUBPROCESS_MAX_INPUT_BYTES = JSON_MAX_BYTES
SUBPROCESS_MAX_OUTPUT_BYTES = 32 * MIB
ARTIFACT_STORE_MAX_BYTES = 32 * MIB
CONNECTOR_RESULT_CACHE_MAX_BYTES = 32 * MIB
NETWORK_MATERIAL_MAX_BYTES = 32 * MIB
HTTP_MEMO_MAX_BYTES = 32 * MIB
