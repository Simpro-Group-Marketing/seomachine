...
- **Simpro web copy rules**: Use numerals for cardinal numbers, including 1-9. Do not write number words such as "one," "two," or "three" in final public copy. Always put a comma before "because".
