...
10. Validate the already frozen editorial plan, then run the six machine reviewers against that exact plan. Route plan-level changes to `/analyze-existing`; do not mutate the plan inside `/rewrite`.
