...
SECTIONS = [
    ...
    section(2, "body_explanation", "What is COSHH, and why is it important?", 200,
            ...
            angle="Open with the COSHH meaning, define it, then show the stakes with current primary sources.",
    ...
    section(11, "body_explanation", "How often should a COSHH assessment be reviewed?", 170,
            question="How often should a COSHH assessment be reviewed?",
            payoff="Regularly, immediately after any of three legal triggers, and with a recorded update once you employ 5 or more people.",
...
PLAN = {
    ...
    "meta": {
        "meta_title": "COSHH Regulations: Key Rules & Assessment Guide | BigChange",
        "meta_description": "Understand COSHH regulations, the 3 key rules employers need to know, and how to carry out a COSHH assessment step by step. Includes a field-job checklist.",
    ...
    "entity_map": {
        ...
        "supporting": [
            "hazardous substance", "safety data sheet", "local exhaust ventilation",
            "health surveillance", "personal protective equipment", "hierarchy of control",
    ...
    "engagement_map": {
        "cta_exception_reason": "The brief requires a conclusion section with a CTA, and the section 13 risk assessment feature link is the required commercial pillar, so this ToFu article carries one contextual and one closing CTA.",
