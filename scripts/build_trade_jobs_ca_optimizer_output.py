"""Build current-release optimizer evidence for the best-trade-jobs-california rewrite.
...
def parser() -> argparse.ArgumentParser:
    result = argparse.ArgumentParser(
        description="Build simpro-optimizer-output/v2 for the best-trade-jobs-california rewrite."
    )
    result.add_argument(
        "--preflight-readiness",
        required=True,
